...
// 現場銷售「結帳時補庫存」稽核紀錄。
//
// 為什麼要有這一頁：現場銷售的數量**不擋結帳** —— 帳上不夠的部分由 RPC 自動
// 補一筆 manual_adjust 再賣掉（20260901040000）。那是全站少數**憑空生庫存**的
// 入口，而且是自動的、店員不會特別意識到。on_hand 淨變化 0，所以帳面上看不出
// 差異 —— **這份清單就是唯一的訊號**。沒有人看的話，權宜之計會變成日常，
// 帳與實體越差越遠 —— CLAUDE.md 記過的幽靈庫存災情都是這個形狀。
//
