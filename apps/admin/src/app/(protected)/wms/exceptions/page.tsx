...
//   5. 撿貨破損 — picking_wave_items 破損標記(暫無此 schema,先佔位)

import Link from "next/link";
import { useEffect, useMemo, useState } from "react";
import { getSupabase } from "@/lib/supabase";
import SpinButton from "@/components/SpinButton";
import { TransferShortageResolveModal, type ShortageContext } from "@/components/TransferShortageResolveModal";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // 1. 進貨異常 — 透過 v_picking_demand_by_po 找 qty_shortage / 撈 GR 找 damage / 找 overage
        ...
        // 2. GR damage — 從 goods_receipt_items 找 qty_damaged > 0
        ...
        // 4. Transfer 收貨短少 — transfer_items 收貨後 qty_received < qty_shipped 且未處理
        ...
        // SKU 名稱 lookup(damage / transfer 用)
        ...
        // 1. 進貨短少 — 已從 v_picking_demand_by_po 拿(go through unique sku per po)
