              ...
              return (
                ...
                >
                  <td className="px-3 py-2 font-mono text-xs">
                    ...
                    {r.is_restock && <span className="ml-2 inline-block rounded bg-indigo-100 px-1 py-0.5 text-[10px] text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300" title="此 PO 來自補貨申請,走 HQ Inbox 派貨流程,不經撿貨工作站">🔁 補貨</span>}
                  </td>
